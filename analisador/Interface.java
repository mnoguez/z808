       ...
       while(true){
           ...
           if(token == null){
               ...
               switch(token){                
                ...
                case DIRETIVAS:
                    //cont++;
                    resultado = resultado + "Linha: " + cont +  "<DIRETIVAS> " + lexer.lexeme + "\n" ;
                    break;
                ...
                case SEPARADOR:
                    ...
                    break;
                     ...
                     case ASSUME:
                    //cont++;
                    resultado = resultado + "Linha: " + cont +  "<ASSUME> " + lexer.lexeme + "\n";
                    break;
                ...
                case DW:
                   ...
                   case REGISTRADOR:
                    //cont++;
                    resultado = resultado + "Linha: " + cont +  "<REGISTRADOR> " + lexer.lexeme + "\n";
                    break;
                 
                    case PONTO_INT:
                    //cont++;
                    resultado = resultado + "Linha: " + cont +  "<PONTO_INTERROGACAO> " + lexer.lexeme + "\n";
                    break;
                    
                    case PROP_ASSUME:
                    //cont++;
                    resultado = resultado + "Linha: " + cont +  "<PROPRIEDADES_ASSUME> " + lexer.lexeme + "\n";
                    break;
